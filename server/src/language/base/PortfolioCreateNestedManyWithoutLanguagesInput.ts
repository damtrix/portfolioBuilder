...
@InputType()
class PortfolioCreateNestedManyWithoutLanguagesInput {
...
export { PortfolioCreateNestedManyWithoutLanguagesInput as PortfolioCreateNestedManyWithoutLanguagesInput };
