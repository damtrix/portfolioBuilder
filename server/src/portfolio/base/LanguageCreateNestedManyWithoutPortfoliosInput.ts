...
@InputType()
class LanguageCreateNestedManyWithoutPortfoliosInput {
...
export { LanguageCreateNestedManyWithoutPortfoliosInput as LanguageCreateNestedManyWithoutPortfoliosInput };
